                    ...
                    <div class="login__form">
                        ...
                        <form method="POST" action="<?= base_url('auth'); ?>">
                            <div class="input__item">
                                <input type="text" name="email" value="<?= set_value('email'); ?>" placeholder="Email address">
                                <span class="icon_mail"></span>
                                <?= form_error('email', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="input__item">
                                <input type="password" name="password" value="<?= set_value('nama'); ?>" placeholder="Password">
                                <span class="icon_lock"></span>
                                <?= form_error('password', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <button type="submit" class="site-btn">Login Now</button>
                        </form>
                        <a href="<?= base_url('auth/lupapassword'); ?>" class="forget_pass">Forgot Your Password?</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="login__register">
                        <h3>Dont’t Have An Account?</h3>
                        <a href="<?= base_url('auth/registrasi'); ?>" class="primary-btn">Register Now</a>
                    </div>
                </div>
            </div>
    </section>
