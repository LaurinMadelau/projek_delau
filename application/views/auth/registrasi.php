            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="login__form">
                        ...
                        <form action="<?= base_url('auth/registrasi')?>" method="POST">
                            ...
                            <div class="input__item">
                                <input type="text" name="nama" id="nama" value="<?= set_value('nama'); ?>" placeholder="Your Name">
                ...
                <div class="col-lg-5 col-md-10 col-sm-10">
                 <div class="product__item">
                     <div class="product__item__pic set-bg" data-setbg="<?=base_url('assets/')?>img/hero/valorant3.jpg">
                     </div>
            </div>
        </div>
    </section>
